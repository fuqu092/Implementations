...
class Discriminator(nn.Module):
    def __init__(self, channels_img, features_d):
        ...
        self.disc = nn.Sequential( # N x channels_img x 64 x 64 
                nn.Conv2d(channels_img, features_d, 4, 2, 1), # 32 x 32
                nn.LeakyReLU(0.2),
                ...
                self.block(features_d*8, 1, 4, 2, 0), # 1 x 1
                nn.Sigmoid(),
            )
...
class Generator(nn.Module):
    def __init__(self, z_dim, channels_img, features_g):
        ...
        self.gen = nn.Sequential( # N x z_dim x 1 x 1 
                self.block(z_dim, features_g*16, 4, 1, 0), # 4 x 4
                ...
                nn.ConvTranspose2d(features_g*2, channels_img, 4, 2, 1), # 64 x 64
                nn.Tanh(),
            )
